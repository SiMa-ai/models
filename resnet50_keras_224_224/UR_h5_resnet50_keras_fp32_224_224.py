...
def _get_import_params(*args, **kwargs):
    ...
    if framework == "onnx" and layout == "NHWC":
        ...
        params = keras_source(*args, **kwargs)
    return params
...
def main(arm_only, asym, per_ch, calibration,
  ...
  input_dtypes = [scalar_type_from_dtype("float32")]
    ...
    args = {'model_path': 'models/UR_h5_resnet50_keras_fp32_224_224.h5', 'shape_dict': '', 'layout': 'NCHW'}
    ...
    sdk_net = loaded_net.quantize(
        ...
        model_name="UR_h5_resnet50_keras_fp32_224_224",
        arm_only=arm_only
    )
    ...
    saved_model_name = f"UR_h5_resnet50_keras_fp32_224_224_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"UR_h5_resnet50_keras_fp32_224_224_asym_{asym}_per_ch_{per_ch}.sima"
...
if __name__ == "__main__":
    main(False, True, True, 'entropy', False, False, False, False)
    #main(False, True, True, 'percentile', False, False, False, False)
