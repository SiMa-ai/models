...
def main(arm_only, asym, per_ch, calibration,
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/dla-34/dla-34.onnx"):
            args['model_path'] = "openvino/public/dla-34/dla-34.onnx"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/dla-34/dla-34.onnx"
    ...
    saved_model_name = f"dla-34_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"dla-34_asym_{asym}_per_ch_{per_ch}.sima"
