...
def main(arm_only, asym, per_ch, calibration,
    ...
    args2 = {'model_path': '/project/jenkinsagents/qa/models/toolbox_benchmark_models/unrestricted/image_classification/onnx/UR_onnx_efficientnet-lite4-11_fp32_224_224.onnx', 'shape_dict': '', 'dtype_dict': ''}
