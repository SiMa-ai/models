...
def main(arm_only, asym, per_ch, calibration,
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/efficientnet-v2-b0/efficientnet-v2-b0.onnx"):
            args['model_path'] = "openvino/public/efficientnet-v2-b0/efficientnet-v2-b0.onnx"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/efficientnet-v2-b0/efficientnet-v2-b0.onnx"
    ...
    saved_model_name = f"efficientnet-v2-b0_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"efficientnet-v2-b0_asym_{asym}_per_ch_{per_ch}.sima"
