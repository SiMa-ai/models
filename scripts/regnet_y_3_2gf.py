...
def main(arm_only, asym, per_ch, calibration, 
    ...
    model_path1 = "torchvision_onnx_models/regnet_y_3_2gf.onnx"
    model_path2 = "/project/jenkinsagents/qa/models/torchvision_onnx_models/regnet_y_3_2gf.onnx"
    ...
    saved_model_name = f"regnet_y_3_2gf_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"regnet_y_3_2gf_asym_{asym}_per_ch_{per_ch}.sima"
