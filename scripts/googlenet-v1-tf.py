...
def main(arm_only, asym, per_ch, calibration,
    ...
    # Model information
    input_names, input_shapes, input_type = ("serving_default_keras_layer_input:0", (1, 224, 224, 3), ScalarType.float32)
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/googlenet-v1-tf/googlenet-v1-tf.tflite"):
            args['model_path'] = "openvino/public/googlenet-v1-tf/googlenet-v1-tf.tflite"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/googlenet-v1-tf/googlenet-v1-tf.tflite"
    ...
    saved_model_name = f"googlenet-v1-tf_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"googlenet-v1-tf_asym_{asym}_per_ch_{per_ch}.sima"
