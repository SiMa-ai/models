...
def main(arm_only, asym, per_ch, calibration,
    ...
    # Model information
    input_names, input_shape, input_type = ("input", (1, 3, 384, 288), ScalarType.float32)
    ...
    if 'model_path' in args.keys():
        args['model_path'] = "models/single-human-pose-estimation-0001.onnx"
    ...
    if type(input_names) is not list:
        ...
        inputs = {InputName(input_name): np.random.rand(1, 3, 384, 288) for input_name in input_names}
