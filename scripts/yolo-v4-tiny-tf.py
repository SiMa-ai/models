...
def main(arm_only, asym, per_ch, calibration,
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/yolo-v4-tiny-tf/yolo-v4-tiny-tf.tflite"):
            args['model_path'] = "openvino/public/yolo-v4-tiny-tf/yolo-v4-tiny-tf.tflite"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/yolo-v4-tiny-tf/yolo-v4-tiny-tf.tflite"
    ...
    saved_model_name = f"yolo-v4-tiny-tf_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"yolo-v4-tiny-tf_asym_{asym}_per_ch_{per_ch}.sima"
