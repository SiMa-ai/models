...
def main(arm_only, asym, per_ch, calibration,
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/repvgg-b3/repvgg-b3.onnx"):
            args['model_path'] = "openvino/public/repvgg-b3/repvgg-b3.onnx"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/repvgg-b3/repvgg-b3.onnx"
    ...
    saved_model_name = f"repvgg-b3_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"repvgg-b3_asym_{asym}_per_ch_{per_ch}.sima"
