...
def main(arm_only, asym, per_ch, calibration,
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/mobilenet-v1-1.0-224-tf/mobilenet_v1_1.0_224.tflite"):
            args['model_path'] = "openvino/public/mobilenet-v1-1.0-224-tf/mobilenet_v1_1.0_224.tflite"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/mobilenet-v1-1.0-224-tf/mobilenet_v1_1.0_224.tflite"
