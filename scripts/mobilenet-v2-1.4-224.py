...
def main(arm_only, asym, per_ch, calibration,
    ...
    # Model information
    input_names, input_shapes, input_type = ("input", (1, 224, 224, 3), ScalarType.float32)
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/mobilenet-v2-1.4-224/mobilenet_v2_1.4_224.tflite"):
            args['model_path'] = "openvino/public/mobilenet-v2-1.4-224/mobilenet_v2_1.4_224.tflite"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/mobilenet-v2-1.4-224/mobilenet_v2_1.4_224.tflite"
    ...
    sdk_net = loaded_net.quantize(
        ...
        model_name="mobilenet-v2-1.4-224",
        arm_only=arm_only
    )
    # Execute the quantized net
    sdk_net_output = sdk_net.execute(inputs=inputs)

    saved_model_name = f"mobilenet-v2-1.4-224_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"mobilenet-v2-1.4-224_asym_{asym}_per_ch_{per_ch}.sima"
