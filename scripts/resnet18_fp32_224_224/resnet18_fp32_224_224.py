...
def main(arm_only, asym, per_ch, calibration,
    ...
    args1 = {'model_path': 'models/UR_pt_resnet18_fp32_224_224.pt', 'input_names': ['input0'], 'input_shapes': [[1, 3, 224, 224]]}
    ...
    sdk_net = loaded_net.quantize(
        ...
        model_name="UR_pt_resnet18_fp32_224_224",
        arm_only=arm_only
    )
    ...
    saved_model_name = f"UR_pt_resnet18_fp32_224_224_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"UR_pt_resnet18_fp32_224_224_asym_{asym}_per_ch_{per_ch}.sima"
