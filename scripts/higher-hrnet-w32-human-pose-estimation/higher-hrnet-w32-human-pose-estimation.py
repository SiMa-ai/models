...
def main(arm_only, asym, per_ch, calibration,
    ...
    # Model information
    input_names, input_shape, input_type = ("input", (1, 3, 512, 512), ScalarType.float32)
    ...
    if 'model_path' in args.keys():
        args['model_path'] = "models/pose_higher_hrnet_w32_512.onnx"
    ...
    if type(input_names) is not list:
        ...
        inputs = {InputName(input_name): np.random.rand(1, 3, 512, 512) for input_name in input_names}
