...
def main(arm_only, asym, per_ch, calibration,
    ...
    args1 = {'model_path': 'models/UR_onnx_densenet-9_fp32_224_224.onnx', 'shape_dict': '', 'dtype_dict': ''}
    args2 = {'model_path': '/project/jenkinsagents/qa/models/toolbox_benchmark_models/unrestricted/image_classification/onnx/UR_onnx_densenet-9_fp32_224_224.onnx', 'shape_dict': '', 'dtype_dict': ''}
    ...
    sdk_net = loaded_net.quantize(
        ...
        model_name="UR_onnx_densenet-9_fp32_224_224",
        arm_only=arm_only
    )
    ...
    saved_model_name = f"UR_onnx_densenet-9_fp32_224_224_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"UR_onnx_densenet-9_fp32_224_224_asym_{asym}_per_ch_{per_ch}.sima"
