...
def main(arm_only, asym, per_ch, calibration,
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/ctdet_coco_dlav0_512/ctdet_coco_dlav0_512.onnx"):
            args['model_path'] = "openvino/public/ctdet_coco_dlav0_512/ctdet_coco_dlav0_512.onnx"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/ctdet_coco_dlav0_512/ctdet_coco_dlav0_512.onnx"
    ...
    saved_model_name = f"ctdet_coco_dlav0_512_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"ctdet_coco_dlav0_512_asym_{asym}_per_ch_{per_ch}.sima"
