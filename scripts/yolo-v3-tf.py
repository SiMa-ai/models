...
def main(arm_only, asym, per_ch, calibration,
    ...
    args = {'model_path': '', 'shape_dict': '', 'output_names': ['conv2d_58/BiasAdd']}
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/yolo-v3-tf/yolo-v3.pb"):
            args['model_path'] = "openvino/public/yolo-v3-tf/yolo-v3.pb"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/yolo-v3-tf/yolo-v3.pb"
    ...
    saved_model_name = f"yolo-v3-tf_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"yolo-v3-tf_asym_{asym}_per_ch_{per_ch}.sima"
