...
def main(arm_only, asym, per_ch, calibration,
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/mobilenet-v2-pytorch/mobilenet-v2-pytorch.onnx"):
            args['model_path'] = "openvino/public/mobilenet-v2-pytorch/mobilenet-v2-pytorch.onnx"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/mobilenet-v2-pytorch/mobilenet-v2-pytorch.onnx"
    ...
    saved_model_name = f"mobilenet-v2-pytorch_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"mobilenet-v2-pytorch_asym_{asym}_per_ch_{per_ch}.sima"
