...
def main(arm_only, asym, per_ch, calibration, 
    ...
    model_path1 = "torchvision_onnx_models/quantized_resnet18.onnx"
    model_path2 = "/project/jenkinsagents/qa/models/torchvision_onnx_models/quantized_resnet18.onnx"
    ...
    sdk_net = loaded_net.quantize(calibration_data,
                                  quant_configs,
                                  model_name="quantized_resnet18",
                                  arm_only=arm_only)
    # Execute the quantized net
    sdk_net_output = sdk_net.execute(inputs=inputs)
        
    saved_model_name = f"quantized_resnet18_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"quantized_resnet18_asym_{asym}_per_ch_{per_ch}.sima"
