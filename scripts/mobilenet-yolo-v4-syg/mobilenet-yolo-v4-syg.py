...
def main(arm_only, asym, per_ch, calibration,
    ...
    # Model information
    input_names, input_shape, input_type = ("input_1", (1, 416, 416, 3), ScalarType.float32)
    ...
    if 'model_path' in args.keys():
        args['model_path'] = "models/mobilenet-yolo-v4-syg.pb"
    ...
    if type(input_names) is not list:
        ...
        inputs = {InputName(input_name): np.random.rand(1, 416, 416, 3) for input_name in input_names}
