...
def main(arm_only, asym, per_ch, calibration,
    ...
    # Model information
    input_names, input_shapes, input_type = ("map/TensorArrayStack/TensorArrayGatherV3", (1, 224, 224, 3), ScalarType.float32)
    args = {'model_path': '', 'shape_dict': '', 'output_names': ['softmax_tensor']}
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/resnet-50-tf/resnet_v1-50.pb"):
            args['model_path'] = "openvino/public/resnet-50-tf/resnet_v1-50.pb"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/resnet-50-tf/resnet_v1-50.pb"
    ...
    saved_model_name = f"resnet-50-tf_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"resnet-50-tf_asym_{asym}_per_ch_{per_ch}.sima"
