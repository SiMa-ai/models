...
def main(arm_only, asym, per_ch, calibration,
    ...
    args = {'model_path': 'models/densenet-9_fp32_224_224.onnx', 'shape_dict': '', 'dtype_dict': ''}
    ...
    sdk_net = loaded_net.quantize(
        ...
        model_name="densenet-9_fp32_224_224",
        arm_only=arm_only
    )
    ...
    saved_model_name = f"densenet-9_fp32_224_224_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"densenet-9_fp32_224_224_asym_{asym}_per_ch_{per_ch}.sima"
