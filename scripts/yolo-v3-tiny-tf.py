...
def main(arm_only, asym, per_ch, calibration,
    ...
    # Model information
    input_names, input_shapes, input_type = ("image_input", (1, 416, 416, 3), ScalarType.float32)
    args = {'model_path': '', 'shape_dict': '', 'output_names': ['conv2d_12/BiasAdd']}
    ...
    if 'model_path' in args.keys():
        if os.path.isfile("openvino/public/yolo-v3-tiny-tf/yolo-v3-tiny-tf/yolo-v3-tiny-tf.pb"):
            args['model_path'] = "openvino/public/yolo-v3-tiny-tf/yolo-v3-tiny-tf/yolo-v3-tiny-tf.pb"
        else:
            args['model_path'] = "/project/jenkinsagents/qa/models/openvino/public/yolo-v3-tiny-tf/yolo-v3-tiny-tf/yolo-v3-tiny-tf.pb"
    ...
    saved_model_name = f"yolo-v3-tiny-tf_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"yolo-v3-tiny-tf_asym_{asym}_per_ch_{per_ch}.sima"
