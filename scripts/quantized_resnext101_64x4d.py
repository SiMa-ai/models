...
def main(arm_only, asym, per_ch, calibration, 
    ...
    model_path1 = "torchvision_onnx_models/quantized_resnext101_64x4d.onnx"
    model_path2 = "/project/jenkinsagents/qa/models/torchvision_onnx_models/quantized_resnext101_64x4d.onnx"
    ...
    sdk_net = loaded_net.quantize(calibration_data,
                                  quant_configs,
                                  model_name="quantized_resnext101_64x4d",
                                  arm_only=arm_only)
    # Execute the quantized net
    sdk_net_output = sdk_net.execute(inputs=inputs)
        
    saved_model_name = f"quantized_resnext101_64x4d_asym_{asym}_per_ch_{per_ch}"
    if load_net:
        ...
        load_model_name = f"quantized_resnext101_64x4d_asym_{asym}_per_ch_{per_ch}.sima"
